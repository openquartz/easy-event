package org.svnee.easyevent.example.limiting;

import static org.svnee.easyevent.example.exception.LimingErrorCode.CONSUME_LIMITING_BLOCKED_ERROR;
...
public class SentinelEventTransferTriggerLimitingControl implements EventTransferTriggerLimitingControl,
    ...
    public void control(EventMessage eventMessage, Consumer<EventMessage> eventHandleFunction) {
        ...
        try {
            ...
            // Blocked.
            throw new LimitingBlockedException(CONSUME_LIMITING_BLOCKED_ERROR);
        } finally {
            if (entry != null) {
                entry.exit();
            }
