...
public class AsyncEventBus extends EventBus {
   ...
   */
  public AsyncEventBus(String identifier, ExecutorService executor) {
   ...
   * @since 16.0
   */
  public AsyncEventBus(ExecutorService executor, SubscriberExceptionHandler subscriberExceptionHandler) {
